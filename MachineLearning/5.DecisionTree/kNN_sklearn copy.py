...
import pandas as pd
data = pd.read_csv('MachineLearning/3.K-NearestNeighbor/code/Astar - Sheet3.csv')
X = data[['length_1','heat_value_1','length_2','heat_value_2','length_3','heat_value_3','length_4','heat_value_4','length_5','heat_value_5','length_ratio','cost_angle_mean']].values
Y = data[['correct']].values.ravel()

X_train, X_test, Y_train, Y_test = train_test_split(X, Y, test_size=0.2)# , random_state=22

from sklearn import linear_model, datasets

model1 = linear_model.LogisticRegression(C=1e5, max_iter=3000)
...
print(result1.mean()) #, result3.mean()
